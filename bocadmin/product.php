...
$(function(){
	$("input[rel=index]").focus(function(){
		...
		$.getJSON("product.php?jsChangeIndex/"+id+"/"+val,function(json){
	...
	<?php foreach($data as $r){?>
		<tr rel="<?=$r->id?>" value="">
            ...
            <td><?php
                ...
                echo admin_photo($pic,$thumb,$r->title);
                ?></td>
...
<ul>
	...
	<li><a href="<?=site_url("$title/searchproduct/$type_id")?>" class="button" rel="ajax"><span>搜索</span></a></li>
</ul>
<div class="page right"><?=$page_link?></div>
<div class="i10"></div>
</div>
