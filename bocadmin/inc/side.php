...
?>
	...
	<li><a href="<?=site_url('[/en/bocadmin]welcome')?>" target="_blank">浏览英文站后台</a></li>-->
	<span>我的帐号</span>
	<li><a href="<?=site_url('password')?>" rel="ajax"><?=$admin_account?></a></li>
	<li><a href="<?=site_url('[/]welcome')?>" target="_blank">浏览前台</a></li>
