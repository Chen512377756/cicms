...
<ul class="halfside">
	...
	<li>类别<br />
		<?=form_dropdown('parent_id',$id_tree,set_value('parent_id',$parent_id))?></li>
	<i class="clear"></i>
	<li>链接<br />
		<?=form_new_input('url','','class="text"')?></li>
	<li>链接类型<br />
		<label><?=form_new_radio('internal',1,true)?>站内</label>
		&nbsp;&nbsp;
		<label><?=form_new_radio('internal',0,false)?>外链</label>
		&nbsp;&nbsp;
		<label><?=form_new_checkbox('ajax',1,false)?>Ajax</label></li>
	<i class="clear"></i>
