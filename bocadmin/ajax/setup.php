...
<div class="form">
<p>备案号<br />
	<?=form_edit_input('icpcode',$rs,'class="text x"')?></p>	
<p>网址<br />
	<?=form_edit_input('weburl',$rs,'class="text x"')?></p>
<p>网站标题<br />
	<?=form_edit_input('title',$rs,'class="text x"')?></p>
<p>网站关键字<br />
	<?=form_textarea('keywords',set_edit_value('keywords',$rs),'style="height:60px;"')?></p>
<p>网站描述<br />
	<?=form_textarea('description',set_edit_value('description',$rs),'style="height:60px;"')?></p>
<p>网站统计代码<br />
	<?=form_textarea('code',set_edit_value('code',$rs),'style="height:60px;"')?></p>
