...
<?=form_open("news/searchnewspost/$type_id",'id="outexcel_form"')?>
...
<ul class="halfside">
	...
	标题：<?=form_new_input('title','','class="text m"')?><br /><br />
	
	时间：<?=form_new_input('expire',date('Y-m-d',time()-3600*24*90),'class="text mydate s"')?>
