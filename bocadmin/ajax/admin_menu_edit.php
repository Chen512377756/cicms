...
<ul class="halfside">
	...
	<li>类别<br />
		<?=form_dropdown('parent_id',$id_tree,set_edit_value('parent_id',$rs))?></li>
	<i class="clear"></i>
	<li>链接<br />
		<?=form_edit_input('url',$rs,'class="text"')?></li>
	<li>链接类型<br />
		<label><?=form_edit_radio('internal',1,$rs)?>站内</label>
		&nbsp;&nbsp;
		<label><?=form_edit_radio('internal',0,$rs)?>外链</label>
		&nbsp;&nbsp;
		<label><?=form_edit_checkbox('ajax',1,$rs)?>Ajax</label></li>
	<i class="clear"></i>
	
	<li>位置<br />
	<?php $arr_location=array(1=>'子类',2=>'类别之前',3=>'类别之后'); ?>
		<?=form_dropdown('move_des',$arr_location,1)?></li>
</ul>
<i class="clear"></i>
</div>
