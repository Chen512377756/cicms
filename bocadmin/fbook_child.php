...
<div class="bdiv">
	<div class="btop">
		...
		<h2><a href="<?=site_url("$title/child/$type_id")?>"><?=$parent_rs->title?>的内页管理</a><em><a href="<?=site_url("$title/child_create/$type_id")?>" rel="ajax"><img src="a/i-add.gif" align="absmiddle" />添加</a></em></h2>
...
<table class="datable" border="0" cellpadding="0" cellspacing="0" height="100%">
	...
	<?php foreach($data as $r){?>
		<tr rel="<?=$r->id?>" value="">
			...
			<td><a href="<?=$r->file?>"><img src="a/doc.gif" width="40px" title="点击下载"></a></td>
