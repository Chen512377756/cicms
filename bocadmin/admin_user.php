...
<script type="text/javascript" src="j/area.js"></script>
</head>
<body>
<div id="wrap">
...
<div class="bdiv">
	<div class="btop">
		...
		<h2><a href="<?=site_url("$title/index/$type_id")?>"><?=$caption?></a><em><?=$total?>个符合&nbsp;&nbsp;<a href="<?=site_url("$title/create/$type_id")?>" rel="ajax"><img src="a/i-add.gif" align="absmiddle" />添加</a></em></h2>
...
<table class="datable" border="0" cellpadding="0" cellspacing="0" height="100%">
	...
	<?php foreach($data as $r){
		...
		?>
		<tr rel="<?=$r->id?>" value="">
			<td><a href="<?=site_url("$title/edit/$type_id/{$r->id}/$page/$order/$each/$cond")?>" title="点击编辑" rel="ajax"><?=$r->account?></a></td>
