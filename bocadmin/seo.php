...
$(function(){
	$("input[rel=index]").focus(function(){
		...
		$.getJSON("seo.php?jsChangeIndex/"+id+"/"+val,function(json){
...
<table class="datable" border="0" cellpadding="0" cellspacing="0" height="100%">
	...
	<?php foreach($data as $r){?>
		<tr rel="<?=$r->id?>" value="">
			...
			<td><a href="<?=site_url("$title/edit/$type_id/{$r->id}/$page/$order/$each/$cond")?>" title="点击编辑" rel="ajax"><?=strcut($r->ktitle,22)?></a></td>
