...
<div class="bdiv">  
	...
	<div class="dialog-bottom">
		<div class="dbleft">
			<label><input type="checkbox" name="remember" value="1" <?=isset($remember)?'checked':''?> /> 记住帐号名称</label>
		</div>
		<div class="dbright">
			<span class="submit"><input type="submit" value="登录" /></span>
		</div>
	<div class="clear"></div>
</div>
</div>  
